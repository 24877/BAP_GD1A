...
<html lang="nl">
	 ...
	 <body>
		...
		<div class="wrapper">
			<form method="GET" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
				<fieldset>
				 ...
				 <input type = "text" name = "input1"  placeholder = "naam"><br>
      ...
      <ul>
          ...
          <li>String 1 getrimd trim():  <?php $string1 = str_replace(' ', '', $input1); echo $input1     ?> </li>
          <li>String 2 getrimd trim():  <?php $string2 = str_replace(' ', '', $input2); echo $input2     ?> </li>
          <li>een concatenation van de twee ingevoerde waarde: <?php echo $string3 = $input1 . $input2?> </li>
          <li>aantal karakters: <?php echo strlen($string3);    ?></li>
